...
namespace vs_nacl.Build.CPPTasks.NaCl
{
    public class AntBuild : TrackedVCToolTask
    {
        ...
        public AntBuild()
            : base(new ResourceManager("vs_nacl.Build.CPPTasks.NaCl.Properties.Resources", Assembly.GetExecutingAssembly()))
        {
        ...
        private void WriteLocalProperties()
        {
            ...
            string fileContents = vs_nacl.Build.CPPTasks.NaCl.Properties.Resources.localproperties_ant_file;
